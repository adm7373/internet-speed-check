...
def test():
        ...
        # tweet if down speed is less than whatever I set
                ...
                try:
                        ...
                        tweet="@Comcast why is my internet speed " + str(int(eval(d))) + "down\\" + str(int(eval(u))) + "up when I pay for 200down\\5up in Boston @ComcastCares @xfinity #comcast #speedtest"
                        twit.statuses.update(status=tweet)
                except Exception,e:
                        print str(e)
                        pass
